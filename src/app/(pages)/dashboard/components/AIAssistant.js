            ...
            <div className="card h-full col-span-1 lg:col-span-1">
                <div className="card-header p-5">
                    <div className="flex items-center">
                        <div className="animate-pulse h-10 w-10 bg-primary/20 rounded-full mr-3"></div>
                        <div className="animate-pulse h-6 bg-muted-foreground/20 w-40 rounded"></div>
                    </div>
                </div>
                <div className="p-5">
                    <div className="animate-pulse h-24 bg-muted-foreground/10 w-full rounded mb-4"></div>
                    <div className="space-y-2">
                        {[...Array(3)].map((_, i) => (
                            <div key={i} className="animate-pulse h-8 bg-muted-foreground/10 w-full rounded"></div>
                        ))}
                    </div>
                </div>
            </div>
        ...
        <div className="card h-full col-span-1 lg:col-span-1">
            ...
            <div className="p-5">
                <div className="bg-muted/50 p-4 rounded-lg mb-4">
                    <p className="text-sm">{insight || 'No insights available at the moment.'}</p>
                </div>
